    ...
    <div>
        <el-card>
            ...
            <el-table :data="userlist" border stripe>
                ...
                <el-table-column prop="endTime" label="项目结束时间" align="center" show-overflow-tooltip></el-table-column>
                <el-table-column prop="actualEndTime" label="实际结束时间" align="center"></el-table-column>
    ...
    data() {
        return {
            ...
            addFormRules: {
                ...
                startTime: [{ required: true, message: '请输入项目开始时间', trigger: 'blur' }],
