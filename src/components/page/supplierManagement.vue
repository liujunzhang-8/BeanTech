    ...
    <div>
        <el-card>
            ...
            <el-table :data="userlist" border stripe>
                <el-table-column prop="supplier" label="公司全称" align="center"></el-table-column>
        ...
        >
            <div>
                ...
                <el-form
                    ...
                    label-width="80px"
                >
                    <el-form-item label="公司全称" prop="supplier">
        ...
        >
            <div>
                ...
                <el-form
                    ...
                    label-width="120px"
                >
                    <el-form-item label="客户公司全称" prop="supplier">
...
export default {
    data() {
        return {
            ...
            // 添加表单的验证规则对象
            addFormRules: {
                supplier: [{ required: true, message: '请输入公司全称', trigger: 'blur' }]
            },
            // 编辑项目
            editForm: {
                supplier: '',
